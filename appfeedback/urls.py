...
urlpatterns = [
    ...
    path('enable-feedback-2/', views.enable_second_feedback_view, name='enable_second_feedback'),
    ...
    path('export-final-feedback/', views.export_final_feedback, name='export_final_feedback'),
